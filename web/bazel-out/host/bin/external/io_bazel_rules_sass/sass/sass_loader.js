...
if (require.main === module) {
  ...
  // NB: 'io_bazel_rules_sass/sass/sass_wrapper' below is replaced during the build process.
  var mainScript = process.argv[1] = 'io_bazel_rules_sass/sass/sass_wrapper';
  try {
