...
export BAZEL_TARGET=@npm//@bazel/terser/bin:terser
...
export BAZEL_NODE_PATCH_REQUIRE=$(rlocation "npm/@bazel/terser/bin/terser_require_patch.js")
...
MAIN=$(rlocation "npm/@bazel/terser/bin/terser_loader.js")
...
for ARG in "${ALL_ARGS[@]:-}"; do
  case "$ARG" in
    ...
    --nobazel_patch_module_resolver)
      MAIN="node_modules/@bazel/terser/index.js"
      ...
      MODULES_MANIFEST=${MODULES_MANIFEST:-$(rlocation "npm/@bazel/terser/bin/_terser.module_mappings.json")}
      ;;
...
if [[ ! -f "$MAIN" ]]; then
  MAIN=$(rlocation "npm/node_modules/@bazel/terser/index.js")
fi
