...
export BAZEL_NODE_PATCH_REQUIRE=$(rlocation "npm/@angular/bazel/bin/ngc-wrapped_require_patch.js")
...
MAIN=$(rlocation "npm/@angular/bazel/bin/ngc-wrapped_loader.js")
...
for ARG in "${ALL_ARGS[@]:-}"; do
  case "$ARG" in
    ...
    --nobazel_patch_module_resolver)
      MAIN="node_modules/@angular/bazel/src/ngc-wrapped/index.js"
      ...
      MODULES_MANIFEST=${MODULES_MANIFEST:-$(rlocation "npm/@angular/bazel/bin/_ngc-wrapped.module_mappings.json")}
      ;;
...
if [[ ! -f "$MAIN" ]]; then
  MAIN=$(rlocation "npm/node_modules/@angular/bazel/src/ngc-wrapped/index.js")
fi
