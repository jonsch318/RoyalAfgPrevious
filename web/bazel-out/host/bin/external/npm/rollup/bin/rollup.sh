...
export BAZEL_TARGET=@npm//rollup/bin:rollup
...
export BAZEL_NODE_PATCH_REQUIRE=$(rlocation "npm/rollup/bin/rollup_require_patch.js")
...
MAIN=$(rlocation "npm/rollup/bin/rollup_loader.js")
...
for ARG in "${ALL_ARGS[@]:-}"; do
  case "$ARG" in
    ...
    --nobazel_patch_module_resolver)
      MAIN="node_modules/rollup/dist/bin/rollup"
      ...
      MODULES_MANIFEST=${MODULES_MANIFEST:-$(rlocation "npm/rollup/bin/_rollup.module_mappings.json")}
      ;;
...
if [[ ! -f "$MAIN" ]]; then
  MAIN=$(rlocation "npm/node_modules/rollup/dist/bin/rollup")
fi
