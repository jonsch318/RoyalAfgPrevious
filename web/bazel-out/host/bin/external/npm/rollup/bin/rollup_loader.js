...
if (require.main === module) {
  ...
  // NB: 'npm/node_modules/rollup/dist/bin/rollup' below is replaced during the build process.
  var mainScript = process.argv[1] = 'npm/node_modules/rollup/dist/bin/rollup';
  try {
