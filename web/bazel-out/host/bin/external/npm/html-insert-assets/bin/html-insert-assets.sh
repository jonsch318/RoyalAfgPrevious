...
export BAZEL_TARGET=@npm//html-insert-assets/bin:html-insert-assets
export BAZEL_WORKSPACE=project
if [[ -z "${BAZEL_NODE_MODULES_ROOT:-}" ]]; then
  export BAZEL_NODE_MODULES_ROOT=npm/node_modules
fi
...
export BAZEL_NODE_PATCH_REQUIRE=$(rlocation "npm/html-insert-assets/bin/html-insert-assets_require_patch.js")
...
MAIN=$(rlocation "npm/html-insert-assets/bin/html-insert-assets_loader.js")
...
for ARG in "${ALL_ARGS[@]:-}"; do
  case "$ARG" in
    ...
    --nobazel_patch_module_resolver)
      MAIN="node_modules/html-insert-assets/src/main.js"
      ...
      MODULES_MANIFEST=${MODULES_MANIFEST:-$(rlocation "npm/html-insert-assets/bin/_html-insert-assets.module_mappings.json")}
      ;;
...
if [[ ! -f "$MAIN" ]]; then
  MAIN=$(rlocation "npm/node_modules/html-insert-assets/src/main.js")
fi
