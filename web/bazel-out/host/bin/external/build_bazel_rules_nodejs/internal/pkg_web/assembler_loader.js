...
if (require.main === module) {
  ...
  // NB: 'build_bazel_rules_nodejs/internal/pkg_web/assembler.js' below is replaced during the build process.
  var mainScript = process.argv[1] = 'build_bazel_rules_nodejs/internal/pkg_web/assembler.js';
  try {
