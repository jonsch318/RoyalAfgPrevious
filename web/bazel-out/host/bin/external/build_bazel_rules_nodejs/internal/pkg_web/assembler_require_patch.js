...
const USER_WORKSPACE_NAME = 'project';
const NODE_MODULES_ROOT = 'build_bazel_rules_nodejs/internal/pkg_web/node_modules';
const BIN_DIR = 'bazel-out/host/bin';
const GEN_DIR = 'bazel-out/host/bin';
const INSTALL_SOURCE_MAP_SUPPORT = false;
const TARGET = '@build_bazel_rules_nodejs//internal/pkg_web:assembler';
